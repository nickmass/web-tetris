...
var Tetris = function (_React$Component) {
  ...
  function Tetris() {
    ...
    return _possibleConstructorReturn(this, (Tetris.__proto__ || Object.getPrototypeOf(Tetris)).apply(this, arguments));
  }
  ...
  _createClass(Tetris, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(PauseOverlay, null),
        _react2.default.createElement(
          'div',
          { style: { height: '100%', float: 'left' } },
          _react2.default.createElement(NextPiece, null),
          _react2.default.createElement(ScoreBox, null)
        ),
        _react2.default.createElement(
          'div',
          { style: { height: '100%', float: 'left' } },
          _react2.default.createElement(PlayArea, null)
        )
      );
    }
  }]);
...
var NextPiece = function (_React$Component2) {
  _inherits(NextPiece, _React$Component2);

  function NextPiece(props) {
    _classCallCheck(this, NextPiece);

    return _possibleConstructorReturn(this, (NextPiece.__proto__ || Object.getPrototypeOf(NextPiece)).call(this, props));
  }

  _createClass(NextPiece, [{
    key: 'updatePiece',
    value: function updatePiece(piece) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement('canvas', { width: '200', height: '200', ref: function ref(canvas) {
...
var ScoreBox = function (_React$Component3) {
  _inherits(ScoreBox, _React$Component3);

  function ScoreBox(props) {
    _classCallCheck(this, ScoreBox);

    var _this4 = _possibleConstructorReturn(this, (ScoreBox.__proto__ || Object.getPrototypeOf(ScoreBox)).call(this, props));
  ...
  _createClass(ScoreBox, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'ul',
        { style: { fontSize: '16pt', listStyle: 'none', margin: '10px' } },
        _react2.default.createElement(
          'li',
          null,
          _react2.default.createElement(ScoreLine, { label: 'Level', value: this.state.level })
        ),
        _react2.default.createElement(
          'li',
          null,
          _react2.default.createElement(ScoreLine, { label: 'Lines', value: this.state.lines })
        ),
        _react2.default.createElement(
          'li',
          null,
          _react2.default.createElement(ScoreLine, { label: 'Score', value: this.state.score })
        )
      );
    }
  }]);
...
var ScoreLine = function ScoreLine(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'span',
      { style: { display: 'inline-block', minWidth: '180px', textAlign: 'right' } },
      value
    )
  );
};

var PauseOverlay = function (_React$Component4) {
  _inherits(PauseOverlay, _React$Component4);

  function PauseOverlay(props) {
    _classCallCheck(this, PauseOverlay);

    var _this5 = _possibleConstructorReturn(this, (PauseOverlay.__proto__ || Object.getPrototypeOf(PauseOverlay)).call(this, props));

    _this5.state = { paused: false };
    return _this5;
  }
  ...
  _createClass(PauseOverlay, [{
    ...
    value: function componentDidMount() {
      ...
      tetris.addEventListener('paused', function (paused) {
        _this6.setState({ paused: paused });
      });
    }
  }, {
    key: 'render',
    value: function render() {
      if (this.state.paused) {
        return _react2.default.createElement(
          'div',
          { style: { position: 'static', width: '100%', height: '100%', backgroundColor: '#000', opacity: '0.3', lineHeight: '500px', verticalAlign: 'middle', fontSize: '40pt' } },
          'PAUSED'
        );
      } else {
...
var PlayArea = function (_React$Component5) {
  _inherits(PlayArea, _React$Component5);

  function PlayArea(props) {
    _classCallCheck(this, PlayArea);

    return _possibleConstructorReturn(this, (PlayArea.__proto__ || Object.getPrototypeOf(PlayArea)).call(this, props));
  }
  ...
  _createClass(PlayArea, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('canvas', { style: playAreaStyle, ref: function ref(canvas) {
...
var TetrisGame = function () {
  ...
  _createClass(TetrisGame, [{
    ...
    value: function trigger(name, data) {
      this.events.filter(function (handler) {
    ...
    value: function updateScore(lines) {
      if (lines != 0) {
        ...
        this.lines += lines;
        var newLevel = (this.lines / 10 | 0) + 1;
    ...
    value: function renderBlocks() {
      var blocks = this.tetris.getBlocks();
      var canvas = document.createElement("canvas");
      canvas.width = this.width * 10;
      canvas.height = this.height * 20;
      var ctx = canvas.getContext('2d');
    ...
    value: function renderPieces() {
      var piece = this.tetris.getActivePiece();
      var dropPiece = this.tetris.getDropPiece();
    ...
    key: 'renderNextPiece',
    value: function renderNextPiece() {
      var piece = this.tetris.getNextPiece();
      var canvas = document.createElement("canvas");
...
_reactDom2.default.render(_react2.default.createElement(Tetris, null), document.getElementById("root"));
